...
def FrameCapture(path,nc,folder): 
    ...
    print("asjdkflajdkfjkdlsajf:  " + str(image))
    count = 0
    ...
    while count <= 25:
        ...
        file_ = folder + str(nc) + "\\" + "frame%d.jpg" % count
        print(file_)
        cv2.imwrite(file_, image)     # save frame as JPEG file         
        success,image = vidcap.read()
        #print('Read a new frame: ', success)
        count += 1
    
    
    print(str(nc) + ", " + str(totalframecount))
